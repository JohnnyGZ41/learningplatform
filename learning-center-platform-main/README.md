...
## Summary
ACME Learning Center Platform, illustrating development with Java, Spring Boot, and Spring Data JPA on MySQL Database. It also illustrates open-api documentation configuration and integration with Swagger UI.
